...
def summarize_docs_from_folder(docs_folder):
    question_prompt_template = """
                        Please provide a detailed summary of the deep learning architecture described in the following text. Highlight key components such as layers, activation functions, loss functions, optimization techniques, and note any unique or innovative aspects compared to standard models.
                        TEXT: {text}
    ...
    refine_prompt_template = """
                    Write a detailed summary focusing specifically on the deep learning architecture described in the following text delimited by triple backquotes.
                    Please return your response in bullet points, highlighting key components such as layers, activation functions, loss functions, optimization techniques, and any specific architecture patterns (e.g., CNN, RNN, Transformer).
                    Also note any unique or innovative aspects of the architecture compared to standard models.
                    ```{text}```
                    DEEP LEARNING ARCHITECTURE BULLET POINT SUMMARY:
                    """
...
folder_path = f"inference/model_architecture/{date_str}"
